...
import com.project.muffle.fragment.*
import com.project.muffle.fragment.RestaurantFragment.Companion.resId
...
class DashboardActivity : AppCompatActivity(), DrawerLocker {
  ...
  //  private lateinit var menuBar: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*User created method to handle the action bar drawer toggle*/
